          ...
          <div class={styles.filterBar}>
            ...
            <Show when={uniqueMaps().length > 1}>
              <MapFilterDropdown
                ...
                clearMapFilter={() => setMapFilter(new Set<string>())}
    ...
    <div ref={wrapperRef} class={styles.mapFilters}>
      ...
      <Show when={props.mapDropdownOpen}>
        <div class={styles.mapFilterDropdown} data-testid="map-filter-dropdown">
                ...
                {(mapName) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Show when={checked()}>
                        <span class={styles.mapFilterOptionCheck}>✓</span>
                      </Show>
                    </button>
                  );
                }}
          ...
          {/* Footer */}
          <Show when={props.mapFilter.size > 0}>
            <div class={styles.mapFilterFooter}>
              <button class={styles.mapFilterClear} onClick={props.clearMapFilter}>
                {props.t("map_filter_clear")} ({props.mapFilter.size})
              </button>
            </div>
          </Show>
        </div>
